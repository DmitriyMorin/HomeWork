public static class Library
{
 ...
 public static void PrintBad(double[] numbers)
{
    Console.Write("[ ");
...
// метод, который заполняет массив случайными числами от 100 до 999
public static void FillArrayRandomNumber(double[] numbers)
 {
    for(int i = 0; i < numbers.Length; i++)
    {
